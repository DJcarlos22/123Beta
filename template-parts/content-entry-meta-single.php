...
<?php
	...
	$author_visible = longriver_is_meta_visible( 'single_post_author', 'single' );
?>
...
<?php if ( 'post' === get_post_type() ) : ?>
	...
	<div class="entry-meta">
		<div class="entry-meta__data">
			...
			<?php $date_visible = longriver_is_meta_visible( 'single_post_publish_date', 'single' );
			...
			<?php $comment_visible = longriver_is_meta_visible( 'single_post_comments', 'single' );
