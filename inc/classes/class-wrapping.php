 ...
 */
add_filter( 'template_include', array( 'Longriver_Wrapping', 'wrap' ), 99 );
add_filter( 'longriver_wrap_base', 'longriver_wrap_base_cpts' );
 ...
 */
function longriver_template_path() {
	return Longriver_Wrapping::$main_template;
}
 ...
 */
function longriver_template_base() {
	return Longriver_Wrapping::$base;
}

if ( ! class_exists( 'Longriver_Wrapping' ) ) {
	...
	class Longriver_Wrapping {
		...
		/**
		 * Initialize new instance of Longriver_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'longriver_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Longriver_Wrapping class.
		 *
		 * @since 1.0.0
 ...
 */
function longriver_wrap_base_cpts( $templates ) {
