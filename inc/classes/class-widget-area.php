...
if ( ! class_exists( 'Longriver_Widget_Area' ) ) {

	/**
	 * Class Longriver_Widget_Area.
	 */
	class Longriver_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'longriver_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'longriver_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'longriver_widget_area_classes', $classes, $area_id );
	 ...
	 * @return object
	 */
	function longriver_widget_area() {
		return Longriver_Widget_Area::get_instance();
	}

	longriver_widget_area();
}
